            ...
            <div class="md:col-span-3 space-y-6">
                ...
                <ul class="space-y-4 text-sm text-white"> 
                    <li class="flex items-start gap-3">
                        ...
                        <span class="font-bold pt-1 leading-snug">Jl. Raya Cimulang No. 45, Kec. Rancabungur, Kab. Bogor, Jawa Barat.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 mt-0.5 shrink-0 text-desa-yellow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span class="font-bold pt-0.5">+62 812-3456-7890</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 mt-0.5 shrink-0 text-desa-yellow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <span class="font-bold pt-0.5">admin@cimulang.desa.id</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="md:col-span-3 space-y-10"> 
                ...
                <div class="space-y-6">
                    ...
                    <ul class="space-y-4 text-sm font-bold">
                        <li>
                            <a href="https://www.instagram.com/desa_cimulang/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 group transition-colors duration-300 hover:text-desa-yellow">
