...
<head>
    ...
    <title>{{ $berita->title }} | Desa Cimulang</title>
...
<body class="font-sans antialiased text-slate-700 bg-slate-50">
    ...
    <nav class="fixed w-full z-50 py-3 bg-white/100 shadow-md backdrop-blur-md border-b border-slate-100"> 
        <div class="container mx-auto px-8 md:px-24 flex justify-between items-center">
            ...
            <a href="{{ route('pojok-warga.index') }}" class="text-sm font-bold text-desa-primary hover:text-desa-dark transition-colors flex items-center gap-2">
        ...
        <div class="container mx-auto px-8 md:px-24">
            ...
            <div class="max-w-4xl mx-auto bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-slate-100">
                ...
                <div class="w-full h-[400px] relative">
                    <img src="{{ asset($berita->img ?? 'images/pojok_warga/default.svg') }}" 
                         alt="{{ $berita->title }}" 
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="flex flex-wrap items-center gap-6 text-sm text-slate-500 border-b border-slate-100 pb-8 mb-8">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="font-bold text-slate-700">Admin Desa</span> {{-- bisa diganti dengan author jika ada --}}
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ \Carbon\Carbon::parse($berita->date_released)->isoFormat('dddd, D MMMM YYYY') }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ \Carbon\Carbon::parse($berita->date_released)->isoFormat('HH:mm') }} WIB</span>
                        </div>
                    </div>
    ...
    {{-- FOOTER (sama seperti di file HTML) --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <ul class="space-y-4 text-sm uppercase font-bold">
                        <li><a href="{{ url('/') }}" class="text-[#FFFFFF] hover:text-[#FFDC2E] transition-colors duration-300">Beranda</a></li>
                        <li x-data="{ open: false }" @mouseleave="open = false" class="relative w-fit">
                            ...
                            <div x-show="open" 
                                ...
                                <a href="{{ url('/sejarah') }}" class="block text-[10px] text-[#FFFFFF] hover:text-[#FFDC2E] transition-colors duration-500">Sejarah</a>
                                <a href="{{ url('/visi-misi') }}" class="block text-[10px] text-[#FFFFFF] hover:text-[#FFDC2E] transition-colors duration-500">Visi & Misi</a>
                                <a href="{{ url('/pemerintah-desa') }}" class="block text-[10px] text-[#FFFFFF] hover:text-[#FFDC2E] transition-colors duration-500">Pemerintah Desa</a>
                            </div>
                        </li>
                        <li><a href="{{ url('/pojok-warga') }}" class="text-[#FFFFFF] hover:text-[#FFDC2E] transition-colors duration-300">Pojok Warga</a></li>
                        <li><a href="{{ url('/potensi-galeri') }}" class="text-[#FFFFFF] hover:text-[#FFDC2E] transition-colors duration-300">Potensi & Galeri</a></li>
                    </ul>
                </div>
                    ...
                    <ul class="space-y-4 text-sm text-white"> 
                        <li class="flex items-start gap-3">
                            <a href="https://maps.app.goo.gl/ZyHxhEZQUnWPSWYc7" target="_blank" class="flex items-start gap-3 hover:text-[#FFDC2E] transition-colors duration-300 group">
                                ...
                                <span class="font-bold pt-1">Jl. Raya Cimulang No. 45, Kec. Rancabungur, Kab. Bogor, Jawa Barat.</span>
                            </a>
                        </li>
                        <li class="flex items-start gap-3">
