...
<head>
    ...
    <title>Pojok Warga Admin | Smart Village Desa Cimulang</title>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b-2 border-slate-100">
                            ...
                            <th class="py-5 px-4 text-[#929397] font-inter font-black text-[10px] uppercase tracking-widest whitespace-nowrap w-64">Judul</th>
                            <th class="py-5 px-4 text-[#929397] font-inter font-black text-[10px] uppercase tracking-widest whitespace-nowrap">Isi Berita</th>
                    ...
                    <tbody>
                        <!-- Looping data Pojok Warga -->
                        @foreach([
                            ['judul' => 'Infrastruktur Digital', 'isi' => 'Pemasangan titik hotspot gratis di area publik desa untuk mendukung digitalisasi UMKM warga Cimulang.'],
                            ['judul' => 'Ketahanan Pangan', 'isi' => 'Program pembibitan padi unggul untuk meningkatkan kualitas panen kelompok tani di wilayah Cimulang.']
                        ] as $index => $berita)
                        ...
                        <tr class="border-b border-slate-50 hover:bg-slate-50/50 transition-colors group">
                            ...
                            <!-- Judul -->
                            <td class="py-5 px-4 text-sm font-inter font-bold text-[#272831] align-top">{{ $berita['judul'] }}</td>
